...
OpenClaw Dashboard 向けのブラウザー拡張強化ツールです。
...
1. GitHub Actions の成果物または Releases から `openclaw-dashboard-plus-extension.zip` を取得します。
2. 安定したフォルダーに展開します。
